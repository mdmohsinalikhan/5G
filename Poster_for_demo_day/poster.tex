...
\vspace{-.75cm} % Alingns the parallel minipages on top
\includegraphics[width=.8\linewidth]{IMSI-catcher.eps}
\hspace{0pt}
\vspace{.15cm} % Alingns the parallel minipages on top
\end{minipage} 
\end{center}
...
\begin{center}
\begin{minipage}[t]{0.9\linewidth} % logo
\vspace{-1.5cm} % Alingns the parallel minipages on top
...
\begin{center}
\begin{minipage}[t]{0.9\linewidth} % logo
\vspace{.1cm} % Alingns the parallel minipages on top
