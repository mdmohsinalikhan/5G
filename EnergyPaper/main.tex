...
\scshape % Small caps
With minor modifications, this article is also accepted as a full paper in The 1st EAI International Conference on 5G for Future Wireless Networks  \\[\baselineskip] \par % Location and year

%\vspace*{2\baselineskip} % Whitespace between location/year and editors

%Edited by \\[\baselineskip]
{\small Mohsin Khan \\ Valtteri Niemi\par} % Editor list
...
\bibitem{Huawei_Vision} 5G A Technology Vision. Available at: http://www.huawei.com/en/industry-insights/huawei-voices/white-papers

\bibitem{5G_Radio_Access-Ericsson} 5G radio
access. Available at: https://www.ericsson.com/res/docs/whitepapers/wp-5g.pdf

\bibitem{NGMN_5G_White_Paper} NGMN 5G White Paper. Available at: https://www.ngmn.org/uploads/media/\\NGMN\_5G\_White\_Paper\_V1\_0.pdf

\bibitem{5G_Nework_Architecture_Whitepaper} 5G Nework Architecture Whitepaper. Available at: http://www.huawei.com/en/industry-insights/huawei-voices/\\white-papers

\bibitem{5G_Scenarios_and_Security_Design} 5G Scenarios and Security Design. Available at: http://www.huawei.com/en/industry-insights/huawei-voices/\\white-papers
