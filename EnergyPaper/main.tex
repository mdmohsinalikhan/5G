...
\hline
Year & Tech & Ref & TP (Gbps) & Gates (K) & Clock Speed (MHz)  &Power (mW) & Scal-able (Y/N) & Throughput per Kilo Gates in Gpbs & Energy per Gbit in $\mu$Joule \\
\hline
...
%$(14.62/8)*1000 = 1827$ 
for 1 giga bit data while providing throughtput of 2.24 Gbps.
