...
\iffalse
In Figure \ref{fig:how_ibc_works}, we show how IBE works pictorially.
\begin{figure}
\begin{center}
% Use the relevant command to insert your figure file.
% For example, with the graphicx package use
