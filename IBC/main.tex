...
\usepackage{url}
\urldef{\mailsa}\path|{mohsinnnn.khan, valtteri.niemi}@helsinki.fi|
...
{\LARGE A Report on \\[0.3\baselineskip] Privacy Protected Subscriber Identification in 5G Network}\\[0.2\baselineskip] % Title
